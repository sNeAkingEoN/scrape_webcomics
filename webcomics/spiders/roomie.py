...
class RoomieSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        yield scrapy.Request(url=link_to_first, callback=self.parse_page, dont_filter=True) # Warum auch immer! Achtung! Evtl. an anderen Stellen entfernen
    ...
    def parse_page(self, response):
        ...
        return (scrapy.Request(url=link_to_next, callback=self.parse_page, dont_filter=True), page_item)
